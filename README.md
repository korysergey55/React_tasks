# React_tasks
    #lesson1: "Components && collections"
        ...
        Task 6. Произведите аналогичные действия по созданию и ренедеру коллекции єлементов для массива laptops из объекта data. Компонент списка целесообразно назвать LaptopList. 
